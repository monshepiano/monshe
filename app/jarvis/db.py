...
_MEMORY_KEY_ALIASES = {
    ...
    "macbook": ("fact", "Устройство", "fact:device"),
    "устройство": ("fact", "Устройство", "fact:device"),
    "компьютер": ("fact", "Устройство", "fact:device"),
    "ноутбук": ("fact", "Устройство", "fact:device"),
    "ram": ("fact", "Оперативная память", "fact:ram"),
    "memory": ("fact", "Оперативная память", "fact:ram"),
    "оперативная память": ("fact", "Оперативная память", "fact:ram"),
