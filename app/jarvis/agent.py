        ...
        raw = llm.chat([
            {"role": "system",
             "content": "Ты генератор коротких кнопок-подсказок для чата с "
                        ...
                        "Опирайся на предметы и факты из ответа (файлы, числа, "
                        "названия, действия), а не на общие слова. Плохо: "
                        "«расскажи подробнее», «что дальше?». Хорошо: "
                        "«добавь уровень с боссом», «сохрани в main.py». "
