...
10. ЖИВЫЕ ЭЛЕМЕНТЫ УПРАВЛЕНИЯ. Предлагаешь варианты на выбор или величину,
   ...
   slider Подпись мин..макс [step шаг] = начальное — число;
   toggle Подпись = on|off — да/нет; button Текст — кнопка действия.
   ...
   максимум 4 элемента. Уместно для настроек, формата, размера, срока, стиля.
   Если вариант один или ответ очевиден — обычный текст, без блока.
